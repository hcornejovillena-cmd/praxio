...
Cada módulo: wizard de carga y validación de datos → análisis → resultados → exportación a Excel → script R equivalente → conclusiones generadas por IA (con fallback automático basado en reglas si no se configura una API key).
...
- `HANDOFF_Kit_v5_Estado_y_Roadmap.md` — estado técnico, arquitectura, roadmap.
